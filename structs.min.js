(function(d){function g(b){if("object"===typeof b){if("string"!==typeof b.u){var a="o"+q++;try{Object.defineProperty(b,"__structs_uid__",{value:a,enumerable:!1,writable:!1,configurable:!1})}catch(c){b.__structs_uid__=a}}return b.__structs_uid__}return"s"+b}var h=this&&this.t||function(b,a){function c(){this.constructor=b}for(var e in a)a.hasOwnProperty(e)&&(b[e]=a[e]);c.prototype=a.prototype;b.prototype=new c},q=0,m=function(){function b(a,c){this.c=0;this.a=a;this.m=c}b.prototype.next=function(){return{done:this.c>=
